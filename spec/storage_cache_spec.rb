  ...
  describe StorageCache do
    ...
    describe "#has_file?" do
      ...
      it "returns false by default" do
        subject.has_file?(version_one).should eq false
        subject.has_file?(version_two).should eq false
      end
      ...
      context "when an existing version of a file exists in the cache" do
        ...
        it "returns true if the given version is the same" do
          subject.has_file?(version_one).should eq true
        end
      end
    end
    ...
    describe "#has_version?" do
      ...
      it "returns false by default" do
        subject.has_version?(version_one).should eq false
        subject.has_version?(version_two).should eq false
      end
      ...
      context "when an existing version of a file exists in the cache" do
        ...
        it "returns true if the given version is the same" do
          subject.has_version?(version_one).should eq true
        end
      end
    end
    ...
    describe "#has_conflict?" do
      ...
      it "returns false by default" do
        subject.has_conflict?(version_one).should eq false
        subject.has_conflict?(version_two).should eq false
      end
      ...
      context "when an existing version of a file exists in the cache" do
        ...
        it "returns true when the given version is different" do
          subject.has_conflict?(version_two).should eq true
        end
